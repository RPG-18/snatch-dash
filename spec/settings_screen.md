...
2. **Карточка оффлайн-карты** тап по ней открывает экран [уравления картами](./offline_maps_screen.md)
3. **Карточка выбора темы карты**. Radio group со значениями: **Светлая**, Темная.
   По умолчанию **Светлая**
4. **Валюта**: выпадаюзий список со значаниеям (**RUB**, INR, USD, EUR, GBP, AUD, CAD, SGD, AED),
